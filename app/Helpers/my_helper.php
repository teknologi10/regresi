...
function jml_temuan($id)
{
	$db = \Config\Database::connect();
	$temuan = $db->table('temuan_detail')->where('id_temuan', $id)->get()->getResultArray();
	// dd($temuan);
	$jml = count($temuan);
...
function jml_rekomendasi($id)
{
	$db = \Config\Database::connect();
	$temuan = $db->table('temuan_detail')
		// ->select('temuan.id, nama_desa, tahun, temuan_detail.id as temuan, rekomendasi.id as rekomendasi')
		->where('id_temuan', $id)
		->join('rekomendasi', 'temuan_detail.id=rekomendasi.id_detail_temuan', 'left')
		->get()->getResultArray();
	// dd($temuan);
	$jml = count($temuan);
...
{
	$db = \Config\Database::connect();
	$temuan = $db->table('rekomendasi')
		// ->select('temuan.id, nama_desa, tahun, temuan_detail.id as temuan, rekomendasi.id as rekomendasi')
		->where('id_detail_temuan', $id)
		->get()->getResultArray();
	// dd($temuan);
	// $jml = count($temuan);
...
function penyebab($id)
{
	$db = \Config\Database::connect();
	$temuan = $db->table('penyebab')
		// ->select('temuan.id, nama_desa, tahun, temuan_detail.id as temuan, rekomendasi.id as rekomendasi')
		->where('id_detail_temuan', $id)
		->get()->getResultArray();
	// dd($temuan);
